...
import (
	...
	cmt "CipherMachine/tsslib/crypto/commitments"
	"CipherMachine/tsslib/crypto/mta"
...
func (p *LocalParty) SetCh(outCh chan <- tss.Message, endCh chan <- common.SignatureData) {
	p.out = outCh
	p.end = endCh
}