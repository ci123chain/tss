...
import (
	...
	"CipherMachine/tsslib/crypto"
	"CipherMachine/tsslib/crypto/paillier"
...
//func (lpsd *LocalPartySaveData) MarshalJSON() ([]byte, error) {
//	type jsonLpsd struct {
//		LocalPreParams
//		LocalSecrets
//
//		// original indexes (ki in signing preparation phase)
...
//}
//
//func (lpsd *LocalPartySaveData) UnmarshalJSON([]byte) error {
//	type jsonLpsd struct {
//
//	}
//}
